...
from clever.tracker.aottracker import get_aot
from clever.tracker.segmentor import Segmentor
from clever.tracker.transfertools import draw_outline, draw_points
from clever.tracker.utils import draw_mask
...
class SegTracker():
    ...
    def seg_acc_bbox(self, origin_frame: np.ndarray, bbox: np.ndarray,):
        ...
        # self.sam.set_image(origin_frame)
    ...
    def seg_acc_click(self, origin_frame: np.ndarray, coords: np.ndarray, modes: np.ndarray, multimask=False):
        '''
