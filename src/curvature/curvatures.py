        ...
        for layer in self.model.modules():
            if layer._get_name() in self.layer_types:
                try:
                    ...
                    keysList = list(temperature_scaling.keys())
                    for index in keysList:
                        temperature_scaling[str(index)] = temperature_scaling.pop(index)
                    temperature = temperature_scaling[str(layer)]
